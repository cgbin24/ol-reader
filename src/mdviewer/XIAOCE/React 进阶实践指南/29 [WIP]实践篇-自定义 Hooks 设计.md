...
![1.jpg](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9fca8bd0234c43fda413c71b2023d8a2~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
- 对于依赖可变性状态的函数或者属性，可以用useCallback来处理。 于是需要把上述自定义 hooks 改版。
...
![3.gif](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5aa90ff8fe8f401e8ba669af510c35d3~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
自定义 hooks 可以通过 useState + useRef 的特性，取其精华，更合理的管理 state。比如如下实现一个同步的state
```js
...
![2.gif](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/abe8ac2134bf40c890a71e0b12688879~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
