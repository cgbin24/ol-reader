...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/11c6cca0522148af9ebb80368613802f~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c8949ce39cad48529a72e827e189e53d~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7b7f0da0a54a468c850603553e8108a7~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![c100d66f-156d-4600-96c2-2838e70ac59b.gif](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f41ba0c2c6ed4c57b5576ab8f8067b9a~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
4. 在 `webpack.server.js` 定义构建服务端资源的配置：
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b2898268b18f4d85ad36eff2b64b79c0~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

页面也能正常运行 `App.jsx` 交互效果：

![840a136d-fe81-42fc-93e0-3d7063c43949.gif](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ae1b5a2d37db4d86ba5a7282a049a0ef~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
就我个人而言，多数情况下我都会选择使用 **Create React App** 或其它脚手架工具快速搭建开发框架，但多数时候又必须 `eject` 出具体配置信息之后手动修改，实现一些定制化需求，此时就需要用上上面介绍的这些知识点。
