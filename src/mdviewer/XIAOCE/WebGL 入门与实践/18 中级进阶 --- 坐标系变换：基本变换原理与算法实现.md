...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/23/166a0297d6ae7194~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
​$\Bigg(\begin{matrix} a & b & c \\ d & e & f \\ g & h & i \end{matrix}\Bigg) × \Bigg(\begin{matrix} x \\ y \\ z \end{matrix}\Bigg) = \Bigg(\begin{matrix} ax+by+cz \\ dx+ey+fz \\ gx+hy+iz \end{matrix}\Bigg)$
​
...
$\Bigg(\begin{matrix} a & b & c & tx \\ c & d & e & ty \\ f & g & h & tz \\ 0 & 0 & 0 & 1 \end{matrix}\Bigg)$
​
...
​$\Bigg(\begin{matrix} a & b & c & tx \\ c & d & e & ty \\ f & g & h & tz \\ 0 & 0 & 0 & 1 \end{matrix}\Bigg)
 × \Bigg(\begin{matrix} x \\ y \\ z \\ 1 \end{matrix}\Bigg) = \Bigg(\begin{matrix} ax+by+cz+tx \\ dx+ey+fz+ty \\ gx+hy+iz+tz \\ 0+0+0+1 \end{matrix}\Bigg)$
...
​$\Bigg(\begin{matrix} U_{xx} & U_{yx} & U_{zx} & O_{x1} \\​ U_{xy} & ​U_{yy} & U_{zy} & O_{y1} \\ U_{xz} & U_{yz} & U_{zz} & O_{z1} \\ 0 &​ 0 & 0 & 1 \end{matrix}\Bigg)$
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/24/166a6a27af075ce0~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
$\Bigg(\begin{matrix} cosβ & −sinβ & 0 & O_{x1} \\ sinβ & cosβ & 0 & O_{y1} \\ 0 & 0 & 1 & O_{z1} \\ 0 & 0 & 0 & ​1 \end{matrix}\Bigg)$
​
...
$\Bigg(\begin{matrix} 1 & 0 & 0 & t_x \\ 0 & 1 & 0 & t_y \\ 0 & 0 & 1 & t_z \\ 0 & 0 & 0 & 1 \end{matrix}\Bigg)$
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/24/166a1c143421a4f3~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/24/166a3da75f85ba1b~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/24/166a3f4f493efad8~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
$x1=r×cos(α+β)=r×cosαcosβ−r×sinαsinβ$

$y1=r×sin(α+β)=r×cosαsinβ+r×sinαcosβ$
...
$P_1= \Bigg(\begin{matrix} cosβ & −sinβ & 0 \\ sinβ & cosβ & 0 \\ 0 & ​0 & 1 \end{matrix}\Bigg)$  
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/24/166a6abab10b4063~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/1/14/1684bb58b07334c9~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)

算法和 X 轴旋转极其相似，就不在这里写了，具体实现请看[这里](https://github.com/lucefer/webgl/blob/master/utils/webgl-matrix.js)。

##### 绕 Z 轴旋转

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/24/166a6ac18384889f~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/25/166a969395da019a~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
$\vec{BZ'}= \vec{AF} × \vec{BC} = \vec{AF} × \vec{AC} − \vec{AF} × \vec{AB} = \vec{AF} × \vec{AC} − 0 = \vec{AF} × \vec{AC}$
 

4、利用三角函数求出 $\vec{BC'}$ 
 
$\vec{BC'}=\vec{BZ'}sinβ+\vec{BC}cosβ$
...
$\vec{AC'}=(\vec{AC} ⋅ \vec{AF})×\vec{AF} +(\vec{AF} × \vec{AC})sinβ+(\vec{AC} −(\vec{AC} ⋅ \vec{AF})×\vec{AF})cosβ$
...
![QianJianTec1694166564264.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7ac63e60ce1d4f25b3a95f8b64f349b6~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=3908&h=441&s=135418&e=png&a=1&b=000000)

利用向量点乘、叉乘规则最终推导出：

$U_x = \Bigg(\begin{matrix} {t_x^2}(1−cosβ)+cosβ \\ {t_x}{t_y}(1−cosβ)+{t_z}sinβ \\ {t_x}{t_z}(1−cosβ)−{t_y}sinβ \end{matrix}\Bigg)$
​

同理，将Y 轴基向量 (0, 1, 0) 代入上面公式，推导可得：

$U_y= \Bigg(\begin{matrix} {t_x}{t_y}(1−cosβ)−{t_z}sinβ \\ {t_y^2}(1−cosβ)+cosβ \\ {t_y}{t_z}(1−cosβ)+{t_x}sinβ \end{matrix}\Bigg)$


$U_z= \Bigg(\begin{matrix} {t_x}{t_z}(1−cosβ)+{t_y}sinβ \\ {t_y}{t_z}(1−cosβ)−{t_x}sinβ \\ {t_z^2}(1−cosβ)+cosβ​\end{matrix}\Bigg)$
...
![QianJianTec1694166506653.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/24c66f9097f249949fb1312e71525e45~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=3877&h=717&s=235594&e=png&a=1&b=000000)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/25/166aaf1eaec1aec8~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
