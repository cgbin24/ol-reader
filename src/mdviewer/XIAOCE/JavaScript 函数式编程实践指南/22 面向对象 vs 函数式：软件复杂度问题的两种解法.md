...
经过 20 多节的学习，此刻的大家已经对函数式编程有了全方位、多角度的理解。这里也是时候收回我在**第2节**留下的伏笔，和大家聊聊 FP vs OOP 这个话题了。
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e298bac58f0a49adb390bf2d73c690f0~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
在**第14节**我们说过，面向对象（OOP）的核心在于继承，而函数式编程（FP）的核心在于组合。
