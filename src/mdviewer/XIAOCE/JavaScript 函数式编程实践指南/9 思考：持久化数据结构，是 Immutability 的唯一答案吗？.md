...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/073c4ef3b9ba404281729f6f9ac9a11e~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

如果你想使用 `produce` 本体验证上述用例，你只需要在项目里引入 `produce` 后，注释掉我们自定义的 `produce` 即可。

`produce` 本体运行该测试用例的执行结果 `console` 如下：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/58f9d44038184527bfd6dfa5b07103ce~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
