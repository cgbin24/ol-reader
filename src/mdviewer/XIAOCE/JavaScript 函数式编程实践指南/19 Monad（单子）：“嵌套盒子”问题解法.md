...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/486b3aa49706488298dde948dc85103f~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/39bd6458506a4c6b8fc6eec881e6c29f~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
决定一个盒子能否成为 Functor 或 Monad 的，并不是方法的命名，而是方法的行为。

> 注：本节我们介绍了 Monad 最直观的作用：数据转换/解决嵌套盒子问题。其实，在软件生产实践中，Monad 还有一个更加广泛、更加实用的实践，那就是”**把副作用放进盒子**“。关于这点，我们在**第26节**会结合 RxJS 作详细的探讨。
