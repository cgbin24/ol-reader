...
而在 Immer.js 中，完整版 `produce` 的浅拷贝其实是可递归的。

举例来说，在本文的案例中，`baseObj` 是一个嵌套对象，一共有两层（如下图红圈所示）：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/184f1ff1dbb9442fa1b30170e245697c~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
简单来说，是为了**解决数据内容变化与数据引用变化不同步的问题**。
