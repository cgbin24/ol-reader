...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/1/24/1687f5b9edd33604~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
DEMO 在线地址（需自行更改数据流地址）：[codepen.io/iwillwen/pe…](https://codepen.io/iwillwen/pen/pGJvNe?editors=0010)

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/1/24/1687f5bd9c690f74~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
DEMO 在线地址：[codepen.io/iwillwen/pe…](https://codepen.io/iwillwen/pen/XObmNd?editors=0010)

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/1/24/1687f5bfaf06d77c~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/1/24/1687f5cbfa8da122~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
但这个时候我们又发现在一般情况下网络都是非常好的，只是稍微出现了一些小波动，而这个判定方法依然将其判定为异常值。所以除了通过控制上限进行判定外，我们还需要添加量个阈值控制。两个阈值分别代表不同的程度，一个较低的阈值代表超过该阈值的 ping 才**有可能**是异常值，而另外一个较高的阈值代表超过该阈值的 ping 一定是异常值。
```js
class OutlierSource {
  // ...
...
DEMO 在线地址：[codepen.io/iwillwen/pe…](https://codepen.io/iwillwen/pen/bzdKYY?editors=0010)

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/1/24/1687f5c50f57c457~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
DEMO 在线地址：[codepen.io/iwillwen/pe…](https://codepen.io/iwillwen/pen/OdVddO?editors=0010)

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/1/24/1687f5c6f4349677~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
